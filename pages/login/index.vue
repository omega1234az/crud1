<template>
  <div class="container mx-auto">
    <div class="flex flex-col items-center justify-center px-6 py-8  md:h-[90vh] lg:py-0">
      <div
...
export default {
  ...
  methods: {
    async login() {
      try {
        const response = await fetch('https://odd-gold-chipmunk-tutu.cyclic.app/user/login', {
          method: 'POST',
          headers: {
